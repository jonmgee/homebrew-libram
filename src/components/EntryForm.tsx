...
import { labelCls, inputCls, textareaCls, ImageUpload, SaveButton } from "./FormParts";
...
function ManualEntryTab({ entryType, parsedData, capturedImage, initialData }: {
  ...
  if (entryType === "species") return <SpeciesForm parsedData={parsedData} capturedImage={capturedImage ?? undefined} initialData={initialData} />;
  if (entryType === "class") return <ClassForm parsedData={parsedData} capturedImage={capturedImage ?? undefined} initialData={initialData} />;
